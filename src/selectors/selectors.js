 ...
 * @param {"boards" | "lists" | "tasks"} type Тип сущностей, по которым производится выборка
 ...
 * @param {"boards" | "lists" | "tasks"} type тип родительской сущности
 ...
 * среди которых производится поиск дочерних сущностей
 * @return {Function} selector - функция, которая принимает Redux state,
